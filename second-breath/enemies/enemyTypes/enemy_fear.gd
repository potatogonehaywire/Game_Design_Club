...
var basic_skill : PackedScene =  preload("res://attack_skills/skill_scenes/basic_fear.tscn")
var max_skill : PackedScene =  preload("res://attack_skills/skill_scenes/max_fear.tscn")
var skillUsed : Node
var lastSkill : int = 2
